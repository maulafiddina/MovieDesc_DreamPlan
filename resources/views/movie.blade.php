...
<body>
    <div class="w-full h-auto min-h-screen flex flex-col">
        ...
        <div class="ml-28 mt-8 flex flex-row items-center">
            ...
            <div class="relative ml-4">
                <select class="block appearance-none bg-white drop-shadow-[0_0px_4px_rgba(0,0,0,0.25)] 
            text-black font-inter py-3 pl-4 pr-8 rounded-lg leading-tight focus:outline-none focus:bg-white"
                    onchange="changeSort(this)">
                    <option value="popularity.desc">Popularity (Teratas)</option>
                    <option value="popularity.asc">Popularity (Terendah)</option>
                    <option value="vote_average.desc">Top Rated (Teratas)</option>
                    <option value="vote_average.asc">Top Rated (Terendah)</option>
                </select>
        ...
        <div class="w-auto pl-28 pr-10 pt-6 pb-10 grid grid-cols-3 lg:grid-cols-5 gap-5" id="dataWrapper">
            ...
            <a href="/movie/{{$movieID}}" class="group">
                <div
                    class="min-w-[232px] min-h-[428px] bg-white drop-shadow-[0_0px_8px_rgba(0,0,0,0.25)] group-hover:drop-shadow-[0_0px_8px_rgba(0,0,0,0.5)] rounded-[32px] p-5 flex flex-col duration-100">
        ...
        <div class="w-full pl-28 pr-10" id="loadMore">
            <button onclick="loadMore()"
                class="w-full mb-10 bg-develobe-500 text-white p-4 font-inter font-bold rounded-xl uppercase drop-shadow-lg">Load
                More</button>
        </div>
    ...
    <!-- ini 03C GA PAHAM DEH AJG GIMANA JELASINNYA NANTI-->
    <script>
