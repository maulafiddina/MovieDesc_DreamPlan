    ...
    <div class="bg-white p-8 rounded shadow-md w-96">
        ...
        <form method="post" action="/register">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" class="mt-1 p-2 w-full border rounded-md" required autofocus
                    value="{{ old('name') }}">
            </div>
            ...
            <!-- Register Button -->
            <button type="submit"
                class="mx-auto bg-gray-500 text-white p-2 rounded-md hover:bg-gray-600">Register</button>
        </form>
